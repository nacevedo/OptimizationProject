                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="card-header">
                                ...
                                <p className="card-category">Ingrese los resultados del modelo de Xpress! Pegue los resultados de Xpress y luego diríjase al tablero de control.</p>
                            </div>
                        </div>
                    </div>
